  ...
  return (
    <section className="flex w-full">
      ...
      <div className="relative w-[60%] h-[1000px] overflow-hidden">
        <Image src={booking} fill alt="The Warren Building" className="object-cover" priority/>
      </div>
      ...
      <div className="w-[40%] bg-[#001330] px-12 py-16 flex flex-col justify-center">
        <div className="max-w-2xl mx-auto">
          {/* Title */}
          <h3 className="text-[40px] font-extralight tracking-widest leading-12 text-white mb-6">HOW TO MAKE A BOOKING</h3>

          {/* Description */}
          <p className="text-lg text-gray-300 mb-8 leading-8 tracking-tighter">
            Use our enquiry form to tell us what you&apos;d like to book and we&apos;ll get right back to you. Alternatively, you
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-transparent border-b border-gray-400 text-white placeholder-gray-500 focus:outline-none focus:border-white transition-colors pb-2"
                placeholder=""
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                className="w-full bg-transparent border-b border-gray-400 text-white placeholder-gray-500 focus:outline-none focus:border-white transition-colors pb-2 resize-none"
                rows={2}
                placeholder=""
              />
            </div>
            ...
            {/* Tour Type Select */}
            <div>
              <Select value={formData.tourType} onValueChange={(value) => handleSelectChange("tourType", value)}>
            ...
            <div>
              <Select>
                ...
                <SelectContent className="bg-[#0a2b4d] border-gray-600">
                  <SelectItem value="wedding-ceremony">Ceremony Only</SelectItem>
                  <SelectItem value="wedding-reception">Reception Only</SelectItem>
            ...
            <div className="flex items-center gap-3 pt-4">
              ...
              />
              <label htmlFor="robot" className="text-sm text-gray-300 cursor-pointer">
                I&apos;m not a robot
              </label>
            </div>
            ...
            <div className="pt-6">
              <Button
                type="submit"
                className="bg-amber-600 hover:bg-amber-700 text-white px-8 py-3 rounded-full font-medium tracking-wide"
              >
                Send message
              </Button>
            </div>
